    ...
    return (
        <div>
            <div className="container-login relative">
                <div className="flex boxshadow">
                    <div>
                        <RegisterForm />
                    </div>
                    <div className="w-[450px] bg-[#1261a6] rounded-tr-[20px] rounded-br-[20px] flex flex-col items-center justify-center ">
                        ...
                        <p className="text-white text-[16px] text-center mb-[30px] px-8">
                            Để tiếp tục sử dụng dịch vụ của chúng tôi, vui lòng đăng nhập bằng thông tin của bạn
                        </p>
                        <Link href="/login">
                            <Button
                                type="primary"
                ...
                <div className="absolute left-0 bottom-7 pl-5 pr-5 text-[#1261a6] w-full text-base flex justify-between">
