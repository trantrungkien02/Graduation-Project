        ...
        <div className="footer relative overflow-hidden xl:mt-10 xxl:mt-12">
            ...
            <div className="footer-container overflow-hidden pt-7 sm:pt-8 md:pt-10 xl:pt-16 xxl:pt-20 xxl:mx-auto">
                <div className="footer-content relative text-white grid grid-cols-1 sm:grid-cols-2 md:flex sm:gap-x-6 md:px-10 xl:px-14 pb-10 xl:pb-14 px-6 ">
                    ...
                    />
                    <div className="text-content contact pb-7">
                        <Link href="https://tinasoft.vn/">
                            <Image alt="" src={images.logo} className="w-[160px] h-[115px]" />
                        </Link>
                        <div className="flex flex-col items-start opacity-[0.84] max-w-[19rem]">
                            <Link href="https://mail.google.com/mail/?view=cm&fs=1&to=contact@tinasoft.vn">
                                Email:
                                <span>contact@tinasoft.vn</span>
                            </Link>
                            <Link href="tel:+(84) 246 329 5589">
                                Số điện thoại:
                ...
                <div className="flex justify-between py-2 xxl:py-6 text-white w-10/12 mx-auto">
                    <Link href="https://tinasoft.vn/"> © 2024 TINASOFT VIỆT NAM</Link>
